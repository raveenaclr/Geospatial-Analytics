...
Let us see how to handle geospatial data in R by using appropriate R packages.
...
### 6. Mapping Projection

#### 6.1 Assigning EPSG code 
...
### 7. Importing aspatial data

```{r}
listings <- read_csv("data/aspatial/listings.csv")
```

#### 7.1 Creating simple feature df from aspatial df
...
#### 8.3 Computing Density of preschool by Planning Subzone
...
#### 10.1 How the preschool density is distributed?
...
#### 10.2 What is the r**elationship between Pre-school Density and Pre-school Count?**
