...
-   [**patchwork**](https://cran.r-project.org/web/packages/patchwork/vignettes/patchwork.html)- It has a very simple syntax where we can create layouts super easily. The general syntax that combines:
...
-   [**ggthemes**](https://ggplot2.tidyverse.org/reference/ggtheme.html "ggthemes")- package to use various themes which control all non-display data
...
It reveals that the adjusted r-square of the GWR is 0.8561 which is significantly better than the global multiple linear regression model of 0.6472.
Also, AICc value of the adaptive distance gwr is 41982.22 which is even smaller than the AICc of the fixed distance gwr of 42263.61.
Lesser the AICC, better the model and hence adaptive model is chosen in the subsequent analysis,
