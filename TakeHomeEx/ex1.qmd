...
2.  Next, let us calculate number of waterpoints that fall inside each division by using [*length()*](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/length) function.
